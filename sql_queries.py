...
# TRUNCATE TABLES (limpa os dados mas preserva a estrutura, índices e constraints)
# RESTART IDENTITY reseta as sequences (SERIAL) para 1
# CASCADE propaga o truncate para tabelas dependentes via FK
TRUNCATE_FACT_RIDE_REQUEST_TABLE = "TRUNCATE TABLE fact_ride_request RESTART IDENTITY CASCADE;"
TRUNCATE_FACT_RIDE_TABLE = "TRUNCATE TABLE fact_ride RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_RIDE_FLAGS_TABLE = "TRUNCATE TABLE dim_ride_flags RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_ROUTINE_TABLE = "TRUNCATE TABLE dim_routine RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_REQUEST_STATUS_TABLE = "TRUNCATE TABLE dim_request_status RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_PLACE_TABLE = "TRUNCATE TABLE dim_place RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_USER_TABLE = "TRUNCATE TABLE dim_user RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_HOUR_TABLE = "TRUNCATE TABLE dim_hour RESTART IDENTITY CASCADE;"
TRUNCATE_DIM_DATE_TABLE = "TRUNCATE TABLE dim_date RESTART IDENTITY CASCADE;"
...
ALL_DDL_TRUNCATE_QUERIES = [
    TRUNCATE_FACT_RIDE_REQUEST_TABLE,
    TRUNCATE_FACT_RIDE_TABLE,
    TRUNCATE_DIM_RIDE_FLAGS_TABLE,
    TRUNCATE_DIM_ROUTINE_TABLE,
    TRUNCATE_DIM_REQUEST_STATUS_TABLE,
    TRUNCATE_DIM_PLACE_TABLE,
    TRUNCATE_DIM_USER_TABLE,
    TRUNCATE_DIM_HOUR_TABLE,
    TRUNCATE_DIM_DATE_TABLE
]
...
def get_queries():
    return ALL_DDL_DROP_QUERIES, ALL_DDL_TRUNCATE_QUERIES, ALL_DDL_CREATE_QUERIES